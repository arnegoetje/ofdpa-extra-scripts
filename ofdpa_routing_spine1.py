...
# -*- coding: utf-8 -*-
"""
Created on Thu Dec 20 15:26:07 2018
...
def main():
    ...
    if rc == OFDPA_E_NONE:
        ...
        ingressVlanId = 100
        egressVlanId = 100
        ingressPhysicalPort = 2
        egressPhysicalPort = 1
        routerMacAddress  = "cc:39:ab:d0:d2:20" # my MAC
        nextHopMacAddress = "c4:39:3a:f4:50:4a"
        destinationIpAddress = ip2int('2.2.2.2')
